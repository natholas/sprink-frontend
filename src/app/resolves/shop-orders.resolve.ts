...
export class ShopOrdersResolve implements Resolve<any> {
  ...
  async resolve() {
    ...
    else return await this.orders.getShopOrders(this.state.user.shopId, ['ready', 'pickedup', 'delivered', 'atshop', 'cancelled'])
  }
}