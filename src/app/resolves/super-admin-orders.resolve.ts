...
export class SuperAdminOrdersResolve implements Resolve<any> {
  ...
  async resolve() {
    ...
    else return await this.orders.superAdminGetOrders(['initial', 'ready', 'pickedup', 'delivered', 'atshop', 'error', 'cancelled'])
  }
}